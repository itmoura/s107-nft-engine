package com.omna.nft.model.dto;
...
public class CollectionsNFTDTO {
    ...
    public static CollectionsNFTDTO convert(CollectionsNFT collectionsNFT) {
        var collectionsNFTDTO = new CollectionsNFTDTO();
        BeanUtils.copyProperties(collectionsNFT, collectionsNFTDTO);
        return collectionsNFTDTO;
    }
}
